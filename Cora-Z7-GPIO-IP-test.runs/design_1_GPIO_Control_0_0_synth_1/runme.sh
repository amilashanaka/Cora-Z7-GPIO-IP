...
HD_PWD='C:/Projects/ERN24004/Projects/Cora-Z7-GPIO-IP-test/Cora-Z7-GPIO-IP-test.runs/design_1_GPIO_Control_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_GPIO_Control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_GPIO_Control_0_0.tcl
